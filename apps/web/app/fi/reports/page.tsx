...
// Read-only counterpart to app/vetify/reports/page.tsx -- no generate
// action (PortfolioReport is vetify-signed; financialInstitution is only
// ever an observer in the Daml original).
