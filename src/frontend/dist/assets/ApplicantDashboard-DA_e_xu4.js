import { v as createLucideIcon, j as jsxRuntimeExports, C as Card, e as CardContent, ah as LoaderCircle, Q as TriangleAlert, b as Button, af as RefreshCw, c as CardHeader, d as CardTitle, B as Badge, A as RiskLevel, z as cn, r as reactExports, f as CircleCheck, J as Dialog, K as DialogContent, M as DialogHeader, N as DialogTitle, aw as DialogDescription, h as Label, I as Input, O as DialogFooter, l as ue, S as ShieldCheck, at as KycStatus, t as CircleX, g as useBackend, D as useQueryClient, m as useNavigate, n as useQuery, o as Principal, E as useMutation, F as FullPageLoader, V as RegistrationStatus, P as PageHeader, ae as Scale } from "./index-DiwSGmNR.js";
import { a as RiskLevel__1 } from "./index-B7t3rgHq.js";
import { B as BrainCircuit } from "./credit-card-CXB9DyZH.js";
...
import { T as TawthiqStatusCard } from "./TawthiqStatusCard-UCo47PeW.js";
...
function ApplicantDashboard() {
  ...
  reactExports.useEffect(() => {
    var _a2;
    if (!actor || !((_a2 = profileQuery.data) == null ? void 0 : _a2.userId)) return;
    actor.getProfilePhoto(Principal.fromText(profileQuery.data.userId.toString())).then((result) => {
      if (Array.isArray(result) && result.length > 0 && result[0]) {
        setProfilePhotoUrl(result[0]);
      }
    }).catch(() => {
    });
  }, [actor, (_a = profileQuery.data) == null ? void 0 : _a.userId]);
  const profileUserId = ((_b = profileQuery.data) == null ? void 0 : _b.userId) ?? null;
  ...
  reactExports.useEffect(() => {
    ...
    (_d = (_c = profileQuery.data) == null ? void 0 : _c.kycRecord) == null ? void 0 : _d.kycStatus,
    (_e = tawthiqQuery.data) == null ? void 0 : _e.completedAt,
    mizanQuery.data,
    queryClient
  ]);
  reactExports.useEffect(() => {
      ...
      PageHeader,
      {
        ...
        actions: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ProfilePhotoUpload,
            {
              userId: ((_g = (_f = profileQuery.data) == null ? void 0 : _f.userId) == null ? void 0 : _g.toString()) ?? "",
              displayName,
