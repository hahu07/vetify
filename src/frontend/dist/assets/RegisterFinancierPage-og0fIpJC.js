import { r as reactExports, g as useBackend, a as useRouter, j as jsxRuntimeExports, P as PageHeader, C as Card, e as CardContent, h as Label, I as Input, i as Separator, B as Badge, b as Button, k as LoadingSpinner, l as ue } from "./index-DiwSGmNR.js";
...
function RegisterFinancierPage() {
  ...
  const [complianceError, setComplianceError] = reactExports.useState("");
  ...
  const handleSubmit = async () => {
    if (!validateDetails() || !actor) {
      if (!actor) ue.error("Please connect your wallet before submitting.");
      return;
    }
  ...
  const handleNext = () => {
    if (step === 0 && validateStep0()) setStep(1);
      ...
      const instruments = financierType === "institution" ? instInstruments : financierType === "individual" ? indivInstruments : grpInstruments;
      if (!instruments || instruments.length === 0) {
        setDetailErrors((prev) => ({
          ...prev,
          instruments: "Please select at least one preferred financing instrument"
        }));
        return;
      }
        ...
        step === 2 && financierType === "institution" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              ...
              (detailErrors == null ? void 0 : detailErrors.instruments) && financierType === "institution" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  className: "text-destructive text-sm mt-2",
                  "data-ocid": "register_financier.inst_instruments_error",
                  children: detailErrors.instruments
                }
              )
            ]
          },
        ...
        step === 2 && financierType === "individual" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              ...
              (detailErrors == null ? void 0 : detailErrors.instruments) && financierType === "individual" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  className: "text-destructive text-sm mt-2",
        ...
        step === 2 && financierType === "group" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              ...
              (detailErrors == null ? void 0 : detailErrors.instruments) && financierType === "group" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  className: "text-destructive text-sm mt-2",
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-5 sm:grid-cols-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                  ...
                  (detailErrors == null ? void 0 : detailErrors.riskAppetite) && financierType === "individual" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      className: "text-destructive text-sm mt-1",
                      "data-ocid": "register_financier.indiv_risk_appetite_error",
                      children: detailErrors.riskAppetite
                    }
                  )
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 sm:col-span-2", children: [
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-5 sm:grid-cols-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                  ...
                  (detailErrors == null ? void 0 : detailErrors.riskAppetite) && financierType === "group" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      className: "text-destructive text-sm mt-1",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    complianceError && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
                      {
                        className: "text-destructive text-sm mt-2",
