...
import { g as useBackend, m as useNavigate, r as reactExports, n as useQuery, o as Principal, j as jsxRuntimeExports, F as FullPageLoader, P as PageHeader, B as Badge, U as Users, S as ShieldCheck, C as Card, e as CardContent, b as Button, p as ChevronDown, R as RiskLevel__1, H as HalalComplianceStatus, i as Separator, q as Shield, s as Link2, f as CircleCheck, t as CircleX, _ as __vitePreload } from "./index-DiwSGmNR.js";
...
function ApplicantDetailPanel({ userId, onCollapse }) {
  ...
  const profileQuery = useQuery({
    ...
    queryFn: async () => {
      ...
      return actor.getFinancingReadyBusiness(Principal2.fromText(userId));
    },
...
function FinancierDashboard() {
  ...
  const profile = profileQuery.data;
  const applicants = ((_b = applicantsQuery.data) == null ? void 0 : _b.items) ?? [];
  const total = Number(((_c = applicantsQuery.data) == null ? void 0 : _c.total) ?? applicants.length);
      ...
      PageHeader,
      {
        ...
        actions: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ProfilePhotoUpload,
            {
              userId: ((_e = (_d = profileQuery.data) == null ? void 0 : _d.userId) == null ? void 0 : _e.toString()) ?? "",
              displayName: (profile == null ? void 0 : profile.institutionName) ?? "Financier",
