import { v as createLucideIcon, g as useBackend, a as useRouter, r as reactExports, j as jsxRuntimeExports, P as PageHeader, C as Card, e as CardContent, h as Label, I as Input, b as Button, f as CircleCheck, k as LoadingSpinner, l as ue } from "./index-DiwSGmNR.js";
...
function RegisterBusinessPage() {
  ...
  const [displayAnnualRevenue, setDisplayAnnualRevenue] = reactExports.useState("");
  const [financingAmount, setFinancingAmount] = reactExports.useState("");
  const [displayFinancingAmount, setDisplayFinancingAmount] = reactExports.useState("");
        ...
        step === 4 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-5 sm:grid-cols-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "annualRevenue", children: "Annual Revenue (NGN) *" }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Enter your annual business revenue" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    FieldError,
                    {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "financingAmount", children: "Financing Amount (NGN) *" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground text-sm pointer-events-none", children: "₦" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Input,
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Enter the total financing amount you need" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    FieldError,
                    {
