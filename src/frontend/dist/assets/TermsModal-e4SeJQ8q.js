import { r as reactExports, j as jsxRuntimeExports, J as Dialog, av as DialogTrigger, K as DialogContent, M as DialogHeader, N as DialogTitle, b as Button } from "./index-DiwSGmNR.js";
import { M as MotionConfigContext, i as isHTMLElement, u as useConstant, P as PresenceContext, a as usePresence, b as useIsomorphicLayoutEffect, L as LayoutGroupContext } from "./proxy-Bis1-hmp.js";
...
function TermsModal({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Dialog, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-2xl max-h-[80vh] flex flex-col", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "flex-1 pr-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4 text-sm text-foreground/80 leading-relaxed whitespace-pre-line", children: content.split("\n\n").map((paragraph) => /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: paragraph }, paragraph.slice(0, 40))) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-4 border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "button", className: "w-full", children: "I Understand" }) })
    ] })
  ] });
}
export {
